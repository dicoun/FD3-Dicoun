...
import { productsLoadingAC, productsErrorAC, productsSetAC } from "./productsAllAC";

function productsAllThunkAC(dispatch) {
    ...
    return function() {
        ...
        isoFetch("http://localhost:3000/api/products") 
